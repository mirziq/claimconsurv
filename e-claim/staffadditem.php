			...
			<section id="main" class="wrapper">
				<div class="inner">
					...
					<div class="content">
						...
						<form name="submitclaim" id="submitclaim" method="post" enctype="multipart/form-data" action="additem.php">
							<div class="row">
						...
						<div id="padding">
							...
							<input type="hidden" name="reportid" value="<?php echo $reportid?>" required>
