	...
	<body class="is-preload">
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="content">
						<center><h2><b>Pending Claims</b></h2></center>
						<?php
						 ...
						 ?>
										<div class="table-wrapper">
											<table>
												...
												<tbody>
													<?php
													$result = mysqli_query($con,"select * from claimreports where status='PENDING FROM BOSS'");
													$x= 1;
													...
													echo "</td>";
													echo "<td >";
													echo '<a href="fmviewreport.php?reportid=',$row["reportid"],'">';
													echo "View</a>";
													echo "</td >";
													echo "</tr>";
													$x++;
