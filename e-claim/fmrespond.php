...
<html>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				<a class="logo" href="fmindex.php">DynaConsurv e-Claim</a>
				<nav>
					<a href="#menu">Menu</a>
				</nav>
			</header>
		...
		<nav id="menu">
			...
			<ul class="links">
				<li><a href="fmindex.php">Home</a></li>
							...
							while($row=mysqli_fetch_array($result))
							 ...
							 ?>
								...
								<div id="printabletable">
									...
									<div class="row"  style="  display: flex; flex-wrap: wrap; box-sizing: border-box;">
										<div class="col-6 col-12-medium" style="width: 50%; ">
											<form action="fmreject.php" style="border: none;" method="post">
												<label for="reason" id="toppadding">Reason<span style="color:red;">*</span></label>

												<input type="text" style="padding-bottom: 30px;" name="reason" placeholder="If reject, please provide reason." required>
												<br><br>
										...
										<div class="col-6 col-12-medium" style="width: 50%;">
											...
											<br><br><br><br><br><br>
											<form action="fmaccept.php" style="border: none;" method="get">

												<input type="hidden" name="reportid" value="<?php echo $reportid ?>" >
												<input type="hidden" name="userid" value="<?php echo $userid ?>" >

												<input class="acceptbtn" type="submit" name="submit" value="Accept">
											</form>
										</div>
									</div>
