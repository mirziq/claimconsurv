			...
			<section class="wrapper">
				<div class="inner">
					<header class="special">
						<h2>Welcome, Finance Manager!</h2>
					</header>
					<div class="highlights">
						<section>
							<div class="content">
								<header>
									<a href="fmvalidate.php" class="icon fa-files-o"><span class="label">Icon</span></a>
						...
						<section>
							<div class="content">
								<header>
									<a href="fmpending.php" class="icon fa-vcard-o"><span class="label">Icon</span></a>
									<h3>Pending claim</h3>
								</header>
							</div>
						</section>
						<section>
							<div class="content">
								<header>
									<a href="fmhistory.php" class="icon fa-floppy-o"><span class="label">Icon</span></a>
									<h3>Claim history</h3>
								</header>
							</div>
						</section>
